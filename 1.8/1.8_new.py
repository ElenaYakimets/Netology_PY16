...
class Big_Sheeps (Mammals):
    def __init__(self, kilo):
        super().__init__('sheep', 'bee-bee-bee')
        self.wool = kilo
        self.gives_milk = True
